...
//				calculatePoint = LineUtils.getInknowPoint(listeSegments.get(i), WPSUtils.toRealDistance(WPSUtils.kilometreToMetre(100)));
...
//			
//			//dernier seguement
//			calculatePoint = LineUtils.getLastInknowPoint(listeSegments.get(listeSegments.size()-1), WPSUtils.toRealDistance(WPSUtils.kilometreToMetre(100)));
